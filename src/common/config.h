...
bool getDlssEnabled();
void setDlssEnabled(bool enable, bool is_game_specific = false);
int getDlssQuality();
void setDlssQuality(int quality, bool is_game_specific = false);
bool getDlssFrameGenEnabled();
void setDlssFrameGenEnabled(bool enable, bool is_game_specific = false);
